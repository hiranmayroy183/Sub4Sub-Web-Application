...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (!validateCsrfToken($_POST['csrf_token'])) {
        ...
        $stmt = $pdo->prepare("UPDATE privacy_content SET content = ? WHERE id = 1");
...
$stmt = $pdo->prepare("SELECT content FROM privacy_content WHERE id = 1");
$stmt->execute();
...
<body>
    <div class="container mt-5">
        ...
        <?php endif; ?>
        <form action="adminPrivacy.php" method="post">
