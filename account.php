...
function isProfileComplete($userProfile) {
    return !empty($userProfile['full_name']) &&
           !empty($userProfile['location_address']) &&
           !empty($userProfile['youtube_channel']) &&
           !empty($userProfile['youtube_channel_name']);
}
?>
...
<div class="container">
    <?php if (isLoggedIn()): ?>
        <div class="row mt-5">
            ...
            <?php if (!isProfileComplete($userProfile)): ?>
